<template>
    <div>
        ...
        <el-table border stripe :data="goodsList">
            ...
            <el-table-column width="130px" label="创建时间" prop="add_time"></el-table-column>
            <el-table-column width="190px" label="操作">
                <template slot-scope="scope">
                    <el-button size="mini" icon="el-icon-edit" type="primary">编辑</el-button>
                    <el-button @click="deleteById(scope.row.goods_id)"  size="mini" icon="el-icon-delete" type="danger">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
        <!-- 页脚 -->
